 ...
 * 
 *         Read an image, generate the pattern (number of commits for a given
 *         day) to generate the read image in the GitHub Public Contributions
 *         Overview.
 *
 */
public class ContributionsImage {
	 ...
	 * 
	 * @param image
	 *            The image. 7 pixel high, at most 5 different colors.
	 * @param commitsForColor
	 *            Number of commits assigned to each of the 5 colors (darkest to
	 *            brightest)
	 * @throws IOException 
	 */
	public ContributionsImage(File image, int[] commitsForColor) throws IOException {
	...
	/**
	 * Generate a translation map that has the colors as keys, and the number of
	 * commits as values
	 * 
